...
encodings = tokenizer(test['text'], return_tensors='pt', padding=True, truncation=True, max_length=512).to(device)
...
for i in range(ids.shape[0]):
    ...
    rouge.add(prediction=generated_summary[0], reference=test['text'][i])
