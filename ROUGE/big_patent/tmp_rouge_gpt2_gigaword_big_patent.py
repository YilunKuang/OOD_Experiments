...
rouge = load_metric('rouge', cache_dir='/scratch/yk2516/cache')
...
with open('/scratch/yk2516/OOD_Text_Generation/GPT2-Big-Patent/gen_sum_rouge_gpt2_big_patent.pkl', 'wb') as f:
